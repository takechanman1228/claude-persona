...
|---------|-------|-----------------|--------------|-----------------|
| This page | April 2026 panel | `claude-sonnet-4-6` | A4 / B4 / C2 (tie) | 3.2 |
| [`fable/`](fable/README.md) | Fable-generated panel | `claude-fable-5` | **B7** / A2 / C1 | 3.4 |

The dead heat resolves into a clear Barrier Repair win — the same direction
Fable pushed the original panel in the
[model sensitivity study](../../docs/MODEL-COMPARISON.md).
