...
a different 15-persona panel *generated by* `claude-fable-5` and *answered by*
`claude-fable-5` (the results above use an April 2026 panel answered by
`claude-sonnet-4-6`).

| Edition | Panel | Answering model | First choice | Mean likelihood |
|---------|-------|-----------------|--------------|-----------------|
| This page | April 2026 panel | `claude-sonnet-4-6` | **B7** / A5 / C3 | 3.2 |
| [`fable/`](fable/README.md) | Fable-generated panel | `claude-fable-5` | **B9** / C4 / A2 | 3.53 |

Same winner with a wider margin: cushioning wins on a completely rebuilt
panel too. See the [model sensitivity study](../../docs/MODEL-COMPARISON.md).
