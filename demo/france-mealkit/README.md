...
a different 10-persona panel (same three segments, same 4/3/3 counts)
*generated by* `claude-fable-5` and *answered by* `claude-fable-5`.

| Edition | Panel | Answering model | First choice | Mean likelihood |
|---------|-------|-----------------|--------------|-----------------|
| This page | April 2026 panel | `claude-sonnet-4-6` | **B7** / C3 / **A0** | 3.1 |
| [`fable/`](fable/README.md) | Fable-generated panel | `claude-fable-5` | C4 / A3 / B3 | 3.0 |

**This is the only demo in the set where the winner moved.** With the panel
rebuilt, the race collapses into a three-way split — strong evidence that
these concepts are genuinely close and the striking "A got zero votes"
finding was panel-specific, not a market truth. Read close races with error
bars: [model sensitivity study](../../docs/MODEL-COMPARISON.md).
